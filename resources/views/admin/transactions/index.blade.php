                                ...
                                <tr>
                                    ...
                                    <td class="px-3 py-5 border-b-8 border-white ">
                                        <div class="flex flex-col gap-2 h-full">
                                            <a href="{{ route('admin.transactions.edit', $item->id) }}"  class="btn btn-info px-3 py-2 border rounded flex content-center items-center justify-center gap-1 bg-blue-500 text-white" >
