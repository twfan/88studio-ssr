                ...
                <div class="container w-3/4 p-5 mx-auto flex flex-col">
                    <div class="flex flex-col items-center justify-center">
                        <div class="contentSingle">
                            <form method="POST" action="{{ route('admin.banners.store') }}" class="w-[30rem] flex flex-col gap-3" enctype="multipart/form-data">
                                @if ($errors->any())
                                ...
                                <div class="flex flex-col w-96" id="productNameField">
                                    ...
                                    <input type="text" name="name" class="text-sm border-gray-300 text-sm rounded" value="{{old('name')}}" />
                                </div>
                                ...
                                <div class="flex flex-col w-96">
                                    ...
                                    <select  id="status" name="status" class="text-sm rounded block w-full p-2.5 border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md">
                                        <option value="" class="capitalize" selected disabled>Select status banner</option>
                                        <option value="active" class="text-sm capitalize">Active</option>
                                        <option value="inactive" class="text-sm capitalize">Inactive</option>
                                    </select>
                                </div>
